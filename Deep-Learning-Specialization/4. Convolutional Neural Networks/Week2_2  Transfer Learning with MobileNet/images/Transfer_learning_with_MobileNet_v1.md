...
base_model = tf.keras.applications.MobileNetV2(input_shape=IMG_SHAPE,
                                               include_top=True,
                                               weights='imagenet') # 이전에 사용된 모델의 가중치까지 가져오기
```
...
```python
base_model.summary() 
# 16개의 블록 : (conv2D -> BatchNorm -> ReLU) -> (DepthWise->BacthNorm->ReLU -> Conv2D->BatchNorm)
# 종종 zeroPadding2D들어감
```
...
```
    ...
    Epoch 1/5
    9/9 [==============================] - 8s 934ms/step - loss: 0.7360 - accuracy: 0.5382 - val_loss: 0.4910 - val_accuracy: 0.7538
    Epoch 2/5
    9/9 [==============================] - 8s 846ms/step - loss: 0.5810 - accuracy: 0.6603 - val_loss: 0.4268 - val_accuracy: 0.7231
    Epoch 3/5
    9/9 [==============================] - 8s 846ms/step - loss: 0.5219 - accuracy: 0.6985 - val_loss: 0.3480 - val_accuracy: 0.8462
    Epoch 4/5
    9/9 [==============================] - 8s 857ms/step - loss: 0.4203 - accuracy: 0.7634 - val_loss: 0.3515 - val_accuracy: 0.7538
    Epoch 5/5
    9/9 [==============================] - 8s 834ms/step - loss: 0.4013 - accuracy: 0.8015 - val_loss: 0.2834 - val_accuracy: 0.8615
...
```
    ...
    Epoch 5/10
    9/9 [==============================] - 10s 1s/step - loss: 0.5595 - accuracy: 0.7366 - val_loss: 0.2051 - val_accuracy: 0.9385
    Epoch 6/10
    9/9 [==============================] - 9s 1s/step - loss: 0.3768 - accuracy: 0.7710 - val_loss: 0.2001 - val_accuracy: 0.9692
    Epoch 7/10
    9/9 [==============================] - 9s 1000ms/step - loss: 0.3060 - accuracy: 0.8588 - val_loss: 0.2123 - val_accuracy: 0.8462
    Epoch 8/10
    9/9 [==============================] - 9s 1s/step - loss: 0.2062 - accuracy: 0.8893 - val_loss: 0.0817 - val_accuracy: 1.0000
    Epoch 9/10
    9/9 [==============================] - 9s 1s/step - loss: 0.1781 - accuracy: 0.9160 - val_loss: 0.0502 - val_accuracy: 1.0000
    Epoch 10/10
    9/9 [==============================] - 9s 991ms/step - loss: 0.1300 - accuracy: 0.9389 - val_loss: 0.0782 - val_accuracy: 0.9538
